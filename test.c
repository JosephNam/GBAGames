...
int main(void)
{
    ...
    printf("TEST CASE 8\n should print 0 indicating list is not empty\n");
    printf("%d\n", is_empty(llist));
    empty_list(llist,free_person); 
	printf("\n");
    printf("TEST CASE 9\n should print 1 indicating list is empty\n");
    printf("%d\n", is_empty(llist));
    push_front(llist, create_person("Josephine", 27));
	push_front(llist, create_person("Dave", 34));
	push_front(llist, create_person("Benjamin", 23));
	...
	push_front(llist, create_person("Maximilian", 24));
    printf("\n");
    printf("TEST CASE 10\n should print size is 5\n");
    printf("%d\n",size(llist));
    remove_back(llist, free_person);
	printf("\n");
    printf("TEST CASE 11\n should print that the size is 4\n");
    printf("%d\n",size(llist));
    printf("\n"); 
    printf("TEST CASE 12\n should print list missing josephine\n");
    traverse(llist, print_person);
    printf("\n");
    printf("TEST CASE 13\n should print head and tail, which should be maximillian and dave\n");
